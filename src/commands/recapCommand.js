...
module.exports = async function recapCommand(msg) {
  ...
  if (arr.length == 3)
    return channel.send('What timeframe did you want to search for? Options: `day`, `week`, `month`.\n\nYour command should look like this: `recap "rsn" timeframe.`');
